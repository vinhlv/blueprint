...
import { Classes, Tab, TabList, TabPanel, Tabs } from "../../src/index";
import { queryClassAll } from "../common/domUtils";
...
describe("<Tabs>", () => {
    ...
    it("changes tab focus when arrow keys are pressed", () => {
        ...
        const [tab0, tab1, tab2, tab3] = queryClassAll(testsContainerElement, Classes.TAB);
    ...
    function assertIndicatorPosition(wrapper: ReactWrapper<any, {}>, selectedTabIndex: number) {
        ...
        const expected = (queryClassAll(node, Classes.TAB)[selectedTabIndex]).offsetLeft;
